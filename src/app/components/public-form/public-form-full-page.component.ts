...
import {
  GoabButton,
  GoabButtonGroup,
  GoabCallout, GoabCheckbox, GoabDetails, GoabFieldset, GoabFormItem, GoabInput,
  GoabModal, GoabPublicForm,
  GoabPublicFormPage,
  GoabPublicFormSummary, GoabRadioGroup, GoabRadioItem,
  GoabText, GoabTextArea
...
type Page =
  ...
  | "ineligible";
@Component({
  selector: "app-public-form-full-page",
  standalone: true,
  templateUrl: "./public-form-full-page.component.html",
  imports: [
    GoabPublicFormPage,
...
export class PublicFormFullPageComponent extends PublicFormController<Page> {
  constructor() {
    super("details");
  }
