...
@Component({
  selector: "app-public-form-subform",
  standalone: true,
  templateUrl: "./public-form-subform.component.html",
  imports: [
    GoabPublicFormPage,
    GoabFieldset,
    GoabFormItem,
...
export class PublicFormSubformComponent implements OnInit {
