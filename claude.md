...
2. Create a new angular component under the corresponding components folder. For example, if I give a link to callout, then a new angular component will be under callout folder.
